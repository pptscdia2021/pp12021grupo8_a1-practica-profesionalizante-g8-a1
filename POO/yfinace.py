...
class acciones:
    def __init__(self):
        ...
        self.url="https://pkgstore.datahub.io/core/nasdaq-listings/nasdaq-listed_csv/data/7665719fb51081ba0bd834fde71ce822/nasdaq-listed_csv.csv"


    def scrap_yahoo(self, url_page):
        self.url
...
acciones = acciones()
url = acciones.scrap_yahoo("https://pkgstore.datahub.io/core/nasdaq-listings/nasdaq-listed_csv/data/7665719fb51081ba0bd834fde71ce822/nasdaq-listed_csv.csv")